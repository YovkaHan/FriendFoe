...
export function dataDownload(id, api) {
    return ({type: TYPES.DATA_DOWNLOAD, id, payload: api})
}

export function chooseItem(id, item) {
    return ({type: TYPES.CHOOSE_ITEM, id, payload: {item}})
}
